...
train_predict, eval_predict = gnb_classifier.get_predictions(features=sets.train.x,labels=sets.train.y,eval_features=sets.eval.x)
test_predict = gnb_classifier.classifier.predict(sets.test.x)
